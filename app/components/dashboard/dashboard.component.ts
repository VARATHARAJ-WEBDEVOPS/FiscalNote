...
export class DashboardComponent implements OnInit {
  ...
  Email: any;
  balref: any;
  displayedColumns: string[] = ['Personal Detail', 'Date', 'Due Date', 'Amount', 'Interest', 'Actions']; //Table columns Assigned
  ...
  saveAction(): void { //Save and update Function.
    if (this.employeeFormGroup.valid) {
      const employeeObject: any = this.employeeFormGroup.value;
  ...
  editAction(employeeObject: any): void { //Edit Function., Trigger For Update.
